...
import vec4ShaderMeshCode from "../shaders/vec4-shader-mesh.wgsl";

export class Vec4RendererMesh extends BaseRenderer {
  ...
  getShaderCode() {
    return {
      vertex: vec4ShaderMeshCode,
      fragment: vec4ShaderMeshCode,
    };
  }
  ...
  initialize(): void {
    ...
    this.pipeline = this.device.createRenderPipeline({
      label: "Vec4RendererMesh pipeline",
      layout: layout,
      vertex: {
